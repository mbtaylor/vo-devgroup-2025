...
\begin{center}
  ...
  \vspace*{-.5cm}
  {\bf IVOA Architecture Level #2}

  \burl{https://www.ivoa.net/documents/IVOAArchitecture/}
\end{center}
}
\archSlide{archdiag0.png}{0}
\archSlide{archdiag1.png}{1}
\addtocounter{page}{-1}
\archSlide{archdiag2.png}{2}
\addtocounter{page}{-1}

\slide{Virtual Observatory Standards}
...
\aobSlide{}
\aobSlide{
  \put(29,-19.5){\includegraphics[height=7cm]{flaming-sambuca.jpg}}
}
