...
<VOTABLE version="1.4" xmlns="http://www.ivoa.net/xml/VOTable/v1.3">
  <RESOURCE>
    <TABLE name="dr3lite" nrows="10">
      ...
      <FIELD ID="ra" datatype="float" name="ra" ucd="pos.eq.ra;meta.main" unit="deg">
        <DESCRIPTION>Barycentric Right Ascension in ICRS at epoch J2016.0</DESCRIPTION>
      </FIELD>
      <FIELD ID="dec" datatype="float" name="dec" ucd="pos.eq.dec;meta.main" unit="deg">
...
\begin{picture}(30,0)
  ...
  \put(17,-17){\includegraphics[height=10cm]{moc.png}}
\end{picture}
\vspace*{-1.5cm}
